        ...
        const fetchData = async () => {
            try {
                const [
                    ...
                    axios.get(
                        "http://localhost:5000/api/medecin/institutions",
                        {
                            headers: {
                                Authorization: `Bearer ${localStorage.getItem(
                                    "token"
                        ...
                        <CardContent>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Typography>
                                        <strong>Nom:</strong> {data.medecin.nom}
                                    </Typography>
                                    <Typography>
                                    ...
                                    <Typography>
                                        ...
                                        {data.medecin.specialite_nom ||
                                            "Non spécifiée"}
                                    </Typography>
                                    <Typography>
                                        <strong>Institution:</strong>{" "}
                                        {data.medecin.institution_nom ||
                                            "Aucune"}
                                    </Typography>
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Card
                                        ...
                                        <CardContent>
                                            ...
                                            <Typography>
                                                ...
                                                {
                                                    availability.intervalle_minutes
                                                }{" "}
                                                min
                                            </Typography>
                                            <Typography>
